    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(blank=True, to='modelcompletion.Experiment', on_delete=models.SET_NULL, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='GraphData',
        ...
        migrations.AddField(
            ...
            name='references',
            field=models.ManyToManyField(to='modelcompletion.Reference'),
        ),
        migrations.AddField(
            model_name='ionchannelmodel',
            name='username',
        ...
        migrations.AddField(
            ...
            name='reference',
            field=models.ForeignKey(to='modelcompletion.Reference', on_delete=models.SET_NULL, ),
        ),
        migrations.AddField(
            model_name='experiment',
            name='username',
        ...
        migrations.AddField(
            model_name='cell',
            name='channels',
            field=models.ManyToManyField(to='modelcompletion.IonChannel'),
        ),
    ]
